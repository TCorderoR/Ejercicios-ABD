...
Tiene forma de campana, en donde la mayor parte de los datos o frecuencias
see encuentran en el centro, y los valores minimos en los extremos.
:::
...
valores <- rnorm(3)
```
Valores de una distribución normal estandarizada
:::
